    ...
    return (
        <>
            ...
            <h1 className=" project-title text-5xl text-center font-bold mt-96">
             ...
             <section  className=' porfolio portfolio-section ms-40 mx-20 mt-10 mb-20'>
             {/* <p className='mt-10 text-2xl'>My feature</p> */}
                <div className='PortfolioContainer grid grid-cols-1 gap-5 mt-5 sm:grid-cols-1 md:grid-cols-2 place-items-cente'>  
                ...
                {/* <!-- Project preview Card 001 --> */}
                    ...
                    <div className='portfolio  bg-black pe-3 pb-3 rounded-[3.4rem] '>
                    <div className=' SiteInfo border-[1px] border-black bg-white  p-7 pb-3  rounded-[2.5rem] ' >
